          ...
          <div className="ai-assistant-header mobile-modal-header">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                onClick={onClose}
                className="interactive text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 p-2"
              >
                <X size={18} />
              </Button>
            </div>
              ...
              {allMessages.length === 0 && showSuggestions ? (
                <div className="space-y-8">
                  <div className="text-center breathing-space">
                    ...
                    <h4 className="visual-hierarchy-3 text-gray-900 dark:text-white mb-3">
                    ...
                    return (
                      <div key={idx} className="space-y-4">
                        <div className="flex items-center gap-2">
                          <Icon size={18} className="text-[#5945a3]" />
                ...
                <div className="space-y-6">
                  ...
                  {isTyping && (
                    <div className="flex justify-start">
                      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg max-w-[85%] border border-gray-200 dark:border-gray-700 shadow-sm">
                        <div className="flex items-center gap-3">
