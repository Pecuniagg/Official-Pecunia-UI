  ...
  return (
    <div className="flex h-screen bg-white">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-t border-gray-100 animate-fade-in-up animate-stagger-6">
            <Button
              ...
              className="w-full flex items-center gap-3 bg-gradient-to-r from-[#5945a3] to-[#b37e91] hover:opacity-90 btn-refined"
            >
              <Bot size={20} className="icon-refined" />
              Ask Pecunia
            </Button>
          </div>
        </div>
      ...
      <Button
        ...
        className="fixed bottom-8 right-8 h-14 px-6 bg-gradient-to-r from-[#5945a3] to-[#b37e91] hover:opacity-90 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 animate-pulse-soft hover-lift btn-ripple"
        size="lg"
      >
